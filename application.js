...
comments.limitToLast(10).on('child_added', function(childSnapshot) {
  ...
  $("#link").prepend('<img id="image" onerror="this.src=\"https://upload.wikimedia.org/wikipedia/commons/thumb/a/ac/No_image_available.svg/2000px-No_image_available.svg.png\";">' + '<br> <br>')
